          ...
          <div className="UserIntraction">
            <div className="BTN">
              <div className="CircleAvathar">
                {
                  CurrentData && CurrentData.isLiked ? <svg width={25} height={25} fill='white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
            ...
            <div className="BTN">
              <div className="CircleAvathar">
                {
                  CurrentData && CurrentData.disLike ? <svg width={25} height={25} fill='white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
