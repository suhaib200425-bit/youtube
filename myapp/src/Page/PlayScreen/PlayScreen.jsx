...
function PlayScreen() {
    ...
    return (
        <div className='PlayScreen'>
            ...
            <div className="PlayScreenContent row">
                <div className="col-12 col-md-8 leftBox">
                    <video
                        ref={videoRef}
                        className='col-12 videoplayer'
                        src="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4"
                        controls
                    />
                    <h6 className='Description' >ടെഹ്റാനിൽ ഇറാന്റെ സൈനിക സമുച്ചയം ആക്രമിച്ച് ഇസ്രയേൽ, സംഘർഷത്തിന് അയവില്ല | Iran Israel Attack</h6>
                ...
                <div className="col-12 col-md-4 rightBox p-0">
                    <div className="col-12 row mb-2">
                        ...
                        <div className="col-12 col-md-6">
                            <div className="Discription"> Legacy Of Monsters | Official Trailer (2026) Godzill</div>
                            <div className="channelName">24 News Live</div>
